koko.defineModel('Twitter', function() {
    ...
    this.getPublicTweets = function(eventData, callback, context) {
        koko.loadJSONP('http://api.twitter.com/1/statuses/public_timeline.json?suppress_response_codes&callback=', callback, context);
    };
    ...
    this.getTweetsByName = function(eventData, callback, context) {
        ...
        koko.loadJSONP('http://api.twitter.com/1/statuses/user_timeline.json?suppress_response_codes&screen_name=' + sName + '&callback=', callback, context);
    };

koko.defineModel('Twitter', function() {
    ...
    this.getPublicTweets = function(eventData, callback, callerRef) {
        koko.loadJSON('http://api.twitter.com/1/statuses/public_timeline.json?suppress_response_codes&callback=', 'async', callback, callerRef);
    };
    ...
    this.getTweetsByName = function(eventData, callback, callerRef) {
        ...
        koko.loadJSON('http://api.twitter.com/1/statuses/user_timeline.json?suppress_response_codes&screen_name=' + sName + '&callback=', 'async', callback, callerRef);
    };
